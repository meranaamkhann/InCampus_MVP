...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    @Query("SELECT DISTINCT u.college FROM User u WHERE u.deleted = false AND LOWER(u.college) LIKE LOWER(CONCAT('%', :query, '%')) ORDER BY u.college")
    java.util.List<String> searchColleges(@Param("query") String query);
}
