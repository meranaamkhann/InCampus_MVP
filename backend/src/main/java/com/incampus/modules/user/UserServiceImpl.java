...
public class UserServiceImpl implements UserService {
    ...
    public void follow(UUID currentUserId, UUID targetUserId) {
        ...
        notificationService.notify(targetUserId, currentUserId, NotificationType.NEW_FOLLOWER, null,
    ...
    @Override
    public java.util.List<String> searchColleges(String query) {
        return userRepository.searchColleges(query);
    }
