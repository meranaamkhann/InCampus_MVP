...
public class FriendServiceImpl implements FriendService {
    ...
    public void sendRequest(UUID senderId, UUID receiverId) {
        ...
        friendRequestRepository.save(FriendRequest.builder()
                ...
                .build());
        // TODO(Phase 7 - Notifications): notify receiver of the new friend request.
    }
    ...
    public void acceptRequest(UUID requestId, UUID currentUserId) {
        ...
        // TODO(Phase 7 - Notifications): notify request.getSender() that their request was accepted.
    }
